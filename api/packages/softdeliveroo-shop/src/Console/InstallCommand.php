...
namespace Softdeliveroo\Console;
...
{
    protected $signature = 'softdeliveroo:install';

    protected $description = 'Installing Softdeliveroo Dependencies';

    public function handle()
    {

        $this->info('Installing Softdeliveroo Dependencies...');
        ...
        $this->call('softdeliveroo:copy-files');
    }
}
