...
use SoftDeliveroo\Database\Repositories\UserRepository;
use Illuminate\Validation\ValidationException;
use SoftDeliveroo\Database\Models\User;
use Illuminate\Support\Facades\Hash;
use SoftDeliveroo\Http\Requests\UserCreateRequest;
use SoftDeliveroo\Http\Requests\UserUpdateRequest;
...
use SoftDeliveroo\Http\Requests\ChangePasswordRequest;
use SoftDeliveroo\Mail\ContactAdmin;
use SoftDeliveroo\Database\Models\Permission as ModelsPermission;
...
class UserController extends CoreController
{
    ...
    public function socialLogin(Request $request)
    {
        ...
        try {
            ...
            throw new SoftdeliverooException('PICKBAZAR_ERROR.INVALID_CREDENTIALS');
        }
    ...
    protected function validateProvider($provider)
    {
        if (!in_array($provider, ['facebook', 'google'])) {
            throw new SoftdeliverooException('PICKBAZAR_ERROR.PLEASE_LOGIN_USING_FACEBOOK_OR_GOOGLE');
        }
    }
}
