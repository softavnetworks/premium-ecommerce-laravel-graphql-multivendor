...
use SoftDeliveroo\Database\Models\Withdraw;
use SoftDeliveroo\Database\Repositories\WithdrawRepository;
use SoftDeliveroo\Enums\Permission;
use SoftDeliveroo\Exceptions\SoftdeliverooException;
use SoftDeliveroo\Http\Requests\UpdateWithdrawRequest;
use SoftDeliveroo\Http\Requests\WithdrawRequest;
...
class WithdrawController extends CoreController
{
    ...
    public function store(WithdrawRequest $request)
    {
        ...
        if (isset($validatedData['shop_id'])) {
            ...
            if (isset($balance->current_balance) && $balance->current_balance >= $validatedData['amount']) {
                ...
                throw new SoftdeliverooException('PICKBAZAR_ERROR.INSUFFICIENT_BALANCE');
            }
        } else {
            throw new SoftdeliverooException('PICKBAZAR_ERROR.WITHDRAW_MUST_BE_ATTACHED_TO_SHOP');
        }
    }
    ...
    {
        throw new SoftdeliverooException('PICKBAZAR_ERROR.ACTION_NOT_VALID');
    }
